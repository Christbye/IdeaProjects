...
<link rel="shortcut icon" href="favicon.ico" />
    <script type="text/javascript">
        $(function (){
                $.getJSON("list-kind",function(data) {
                    $(data.list).each(function(i,item){
                        var label = $('<label class="radio-inline"><input type="radio" name="fm.kind" id="optionsRadio'
                                +i+'" value="'+item.id+'"/>'+item.name+'</label>');
                        label.prependTo("#tdiv");
                        //TODO 123
                    });
      				...
      				<div class="portlet-body form">
                        ...
                        <div class="form-body">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-9">
                                 <input type="text" name="fm.name" class="form-control"  placeholder="Enter text">
                              </div>
                           </div>
                           <div class="form-group">
                              <label  class="col-md-3 control-label">来源信息</label>
                              <div class="col-md-9">
                                    <input type="text" name="fm.source" class="form-control"  placeholder="Enter text">
                              </div>
                           </div>
                           <div class="form-group">
                              ...
                              <div class="col-md-9">
                                 <div class="radio-list" onclick="showinput(this);" id="tdiv">
                                    ...
                                    <input type="radio" name="optionsRadios">军事新闻
                                    </label>
