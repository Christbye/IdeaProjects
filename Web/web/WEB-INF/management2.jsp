                     ...
                     <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                           ...
                           <tr>
                              ...
                              <th>
                                  <s:action name="list-kind">
                                      <s:param name="unUseJson" value="true"/>
                                      <s:select name="kind" cssClass="form-control" onchange="changeKind(this.value)" list="#session.kinds" listKey="id" listValue="name" headerKey="文件分类" headerValue="选择分类">
                                      </s:select>
                                  </s:action>
                                  <script type="text/javascript">
                                      function changeKind(v){
                                          alert("list-file.action?unUserJson=true&kind="+v);
                                      }
                                  </script>
                        ...
                        <s:iterator value="list">
                            <tr >
                                ...
                                <td><s:property value="useKind.name"/> </td>
