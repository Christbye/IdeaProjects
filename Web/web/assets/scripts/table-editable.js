    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow) {
                var aData = oTable.fnGetData(nRow);
                var jqTds = $('>td', nRow);
                var aa = aData[1];//获取稳健分类信息
                
                jqTds[0].innerHTML = '<input type="text" class="form-control input-small" value="' + aData[0] + '">';
                jqTds[1].innerHTML = '<select  class="form-control input-medium"><option>军事新闻</option><option>武器装备</option><option>战役与战争</option><option>科技与神秘</option><option>其他</option></select>';
                $('.form-control input-medium').val(aa);
                jqTds[2].innerHTML = '<input type="text" class="form-control input-small" value="' + aData[2] + '">';
                jqTds[3].innerHTML = '<a class="edit" href="">保存</a>';
                jqTds[4].innerHTML = '<a class="cancel" href="">取消</a>';
                //for(var i = 0,j=5;i<j;i++){
                	//if($('.form-control input-medium').val() == aa){
                	//	
                	//}
                //}
