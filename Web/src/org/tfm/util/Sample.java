...
public class Sample {
	...
	static String accessKey = "1s7tdhG2o0VbwoMjVmVaE3Y6";
	static String secretKey = "khhboBuxIUi2HFAAD1rplgpsMQYKSGZI";
	static String bucket = "tigerresource";
	// ----------------------------------------
	static String object = "/media";
